...
(function() {
    bsp_utils.throttle = function(interval, throttledFunction) {
        ...
        return function() {
            ...
            var context = this;
            var now = +__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.now();
...
(function() {
    ...
    function doDomInsert(domInsert) {
        ...
        $items.each(function() {
            if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parents('.hidden').length) {
                $items = $items.not(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this));
            }
        });
        ...
        if ($items.length > 0) {
            ...
            if (beforeInsert) {
                beforeInsert(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.makeArray($items));
            }
            ...
            if (afterInsert) {
                afterInsert(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.makeArray($items));
            }
        }
    }
    ...
    bsp_utils.onDomInsert = function(roots, selector, callbacks) {
        ...
        var domInsert = {
            '$roots': __WEBPACK_IMPORTED_MODULE_0_jquery___default()(roots),
    ...
    function redoAllDomInserts() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(domInserts, function(i, domInsert) {
            doDomInsert(domInsert);
        });
    }
...
(function() {
    ...
    var $d = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document);
    ...
    bsp_utils.plugin = function(globals, namespace, name, actions) {
        ...
        function renameEvents(events) {
            return __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.map(events.match(NOT_WHITE_RE), function(s) {
                return s + '.' + plugin._name;
            }).join(' ');
        }

        plugin._on = function(elements, events, selectorOrHandler, dataOrHandler, handler) {
            var $elements = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(elements);
        ...
        plugin._data = function(elements, key, value) {
            ...
            if ($elements.length === 0) {
                ...
                if (value === undefined) {
                    return __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.data($elements[0], key);

                } else {
                    return $elements.each(function() {
                        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.data(this, key, value);
                    });
                }
            }
        };
        ...
        plugin.option = function(elements, key, value) {
            ...
            if (typeof key === 'undefined') {
                ...
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(elements).each(function() {
        ...
        function updateOptions($element, parentOptions) {
            ...
            plugin._data($element[0], OPTIONS_DATA_KEY, elementOptions ?
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend(true, { }, parentOptions, __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.parseJSON(elementOptions)) :
                    parentOptions);
        }

        // Initialization.
        plugin.live = function(roots, selector, options) {
            var $roots = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(roots);
            ...
            // Update root options.
            $roots.each(function() {
                var $rootElement = this.nodeType === 9 ? __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.documentElement) : __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);

                $rootElement.addClass(plugin._rootClassName);
                updateOptions($rootElement, __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend(true, { }, plugin._defaultOptions, options));
            });
            ...
            if (init) {
                init.call(plugin, __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.makeArray($roots), selector);
            }

            if (each || all) {
                if (selector) {
                    bsp_utils.onDomInsert(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.makeArray($roots), selector, {
                        'insert': function(item) {
                            var $item = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(item).filter(':not(.hidden)');
                        ...
                        'afterInsert': !all ? __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.noop : function(items) {
...
/* harmony default export */ __webpack_exports__["a"] = (bsp_utils);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bsp_utils__ = __webpack_require__(1);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  for (let i = 0; i < 1001; i++) {
    __WEBPACK_IMPORTED_MODULE_0_bsp_utils__["a" /* default */].plugin(false, 'test', i, {
      '_each': function (item) {
        bspLoaded++
        if (bspLoaded >= 1000) {
